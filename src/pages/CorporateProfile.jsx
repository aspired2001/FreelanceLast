            ...
            <div className="mt-16 lg:px-36">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="px-6">
                        ...
                        <p className=" max-sm:text-[16px] text-[18px] text-justify font-serif pt-4">
                            Our Company was incorporated as Balaji Agrotech Industries. Our Company is in the business of processing of non-basmati and basmati rice in India.We are one of the largest processors of non-basmati rice in the State of Jharkhand with a milling capacity of 26 Metric tons per day, and we market our products across Eastern Indian States namely Jharkhand, Bihar, Odisha, West Bengal, and Chhattisgarh.
                    ...
                    <div className="w-full h-full pr-4 max-sm:px-4  ">
                        <img
                            className="rounded shadow-xl hover:-translate-y-2 hover:transition-all cursor-pointer lg:max-w-[480px]  md:ml md:mr-auto"
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap- items-center ">
                        <div>
                            <img
                                className="max-sm:px-4 rounded shadow-xl hover:-translate-y-2 hover:transition-all cursor-pointer lg:max-w-[480px] mx-auto md:ml-auto md:mr-auto lg:ml-4 "
                    ...
                    <div>
                        <p className="  max-sm:text-[16px] text-[18px] text-justify font-serif pt-4 mr-8 pl-4">
                            ...
                            Our Company has established an Ultra Modern Highly Automated Continuous Satake Engineering Paddy Processing & Rice Milling Plant with a installed capacity of 26 Tones per hour. We have established ourselves as one of the Industry Leader in a short span of time with a storage capacity of 85,000 Metric tons and milling capacity of 2,00,000 Metric tons per year.
